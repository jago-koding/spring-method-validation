...
public class AppConfig {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-- ReportTask#createReport() --");
        System.out.println("-- dengan parameter yang tidak valid --");
        try {
        ...
        System.out.println("-- Dengan parameter yang valid tetapi nilai kembali tidak valid --");
        try {
        ...
        System.out.println("-- UserTask#registerUser() --");
        User user = new User();
        user.setEmail("info@jagokoding.id");
        try {
